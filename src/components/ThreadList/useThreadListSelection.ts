...
export function useThreadListSelection({ threads, paginatedThreads }: UseThreadListSelectionOptions) {
  ...
  const toggleSelect = useCallback((threadId: string, shiftKey: boolean) => {
