    ...
    <div className="context-limit-modal">
      <div className="context-limit-content">
        ...
        <p className="context-limit-message">
          This conversation has reached the context window limit. Start a new thread or use Handoff
          to continue with relevant context.
        </p>
        <div className="context-limit-actions">
          ...
          <button className="context-limit-btn dismiss" onClick={onDismiss}>
            Dismiss
          </button>
        </div>
      </div>
